...
export function parseFiltersFromUrl(queryObject) {
  ...
  // Parse price range (accept both new and legacy param names)
  const priceMin = queryObject.priceMin || queryObject.minPrice;
  const priceMax = queryObject.priceMax || queryObject.maxPrice;
